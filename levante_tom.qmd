...
rasch_fit_mode%>% select(question_id, fit_index, mode)%>%pivot_wider(names_from = "fit_index", values_from = "mode")%>% arrange(question_id)
...
coef(rasch_m)$question_id[, , "logalpha_Intercept"] %>% as_tibble(rownames = "question_id")
